...
import com.example.netcharge.ui.theme.lightMainColor2
import com.example.netcharge.ui.theme.mainColor
import com.example.netcharge.ui.theme.redTextColor
...
fun FiltersBottomSheet(
    ...
    filteredNetCharge: MutableList<NetCharge>,
    ...
    Column(
        ...
        CustomFilterButton {
            val filteredNetCharges = netCharges.toMutableList()

            Log.d("MojaLokacija", filteredNetCharges.count().toString())
            if (rangeValues.floatValue != 1000f) {
                filteredNetCharges.retainAll { netcharge ->
                    calculateDistance(
                        userLocation!!.latitude,
                        userLocation.longitude,
                        netcharge.location.latitude,
                        netcharge.location.longitude
            ...
            if (selectedOptions.value.indexOf(true) != -1) {
                ...
                filteredNetCharges.retainAll { it.userId in selectedIndices }
            ...
            filteredNetCharge.clear()
            filteredNetCharge.addAll(filteredNetCharges)
        ...
        CustomResetFilters {
            ...
            netChargeMarkers.addAll(netCharges)
